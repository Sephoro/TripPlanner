...
// let pf = require('./planFunctions.js')
  ...
  .then(function () {
    ...
    addLocationButton.addEventListener('click', function () {
      ...
      if (!validDate(duration.days) || !validActivities(activities)) {
        ...
        // Present the header if its the first time
        if (firstTime) {
        ...
        paragraph.innerHTML = '&#128205 ' + location + ' from ' + start + ' to ' + end + ' : ' + duration.days + duration.string
